...
function usage {
    echo "join-channel.sh   [ORDERER_ADDRESS default=7050] [CHANNEL_NAME default=commercialpaperchannel]"
...
GENESIS_BLOCK=$PWD/../../artefacts/commercialpaper-channel.block
