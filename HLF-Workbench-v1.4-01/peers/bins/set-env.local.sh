...
function usage {
    ...
    echo "               To set  the context to ORG Admin > . set-env.sh  digibank   > . set-env.sh  magnetocorp 8050 "
}
...
CRYPTO_CONFIG_ROOT_FOLDER="../../fabric-ca/client"
...
#2. Sets the MSP ID
# Capitalize the first letter of Org name e.g., digibank => Acme  magnetocorp => Budget
