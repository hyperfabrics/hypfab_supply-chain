...
function usage {
    ...
    echo "               To set  the context to ORG Admin > . set-env.sh  digibank   > . set-env.sh  budget 8050 "
}
...
#2. Sets the MSP ID
# Capitalize the first letter of Org name e.g., digibank => Digibank  budget => Budget
